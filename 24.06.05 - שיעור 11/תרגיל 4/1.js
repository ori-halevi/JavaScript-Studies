...
function sortedPostsForUser(arr, userId) {
  let allUserPosts = arr.filter(user => user.userId === userId).map(user => user.title);
  return allUserPosts;
}

console.log(sortedPostsForUser(sortedArr, 1));
